...
## Setup
Make sure your machine is set up with the project dependencies. 

**[Option 1] Use Anaconda:**
The preferred approach for installing all the project dependencies is to use
...
requirements and you are ready to go directly to working on the project.
...
Run the following from the `project1` directory:
...
from the `project1` directory. If you are unfamiliar with IPython, you should 
...
`start_ipython_osx.sh` script from the `project1` directory; the script
assumes that your virtual environment is named `.env`.

### Submitting your work:
Once you are done working run the `collectSubmission.sh` script;
this will produce a file called `project1.zip`.
Upload this file to bCourses as per the project instructions. 
...
or other ideas not covered in the project then you will be awarded some bonus
points.
